import 'package:balanced_meal/features/create_your_order_feature/presentation/create_your_order_view.dart';
...
import 'package:balanced_meal/features/your_order_summary_feature/presentation/your_order_summary_view.dart';
import 'package:balanced_meal/features/enter_your_details_feature/presentation/enter_your_details_view.dart';
import 'package:balanced_meal/features/welcome_screen_feature/presentation/welcome_screen_view/welcome_screen_view.dart';
...
class AppRouter {
  static var route = GoRouter(
    routes: [
      ...
      GoRoute(
        path: "/CreateYourOrder",
        builder: (context, state) => CreateYourOrderView(),
      ),
      GoRoute(
        path: "/YourOrderSummary",
        builder: (context, state) => YourOrderSummaryView(),
      ),
    ],
  );
}
